...
- [ ] **4.1.1** Create `/api/generate-info-card` function
  ```javascript
...
- [ ] **4.1.2** Create archaeology-specific system prompt
  ```
...
- [ ] **4.1.3** Parse LLM response into structured format
  ```typescript
  interface InfoCard {
    material: string;
...
- [ ] **4.1.4** Handle API errors and rate limits

## 4.2 User Metadata Input

- [ ] **4.2.1** Create metadata input form
...
- [ ] **4.4.2** Export as JSON
  - Structured data for databases
  - Include all fields

- [ ] **4.4.3** Share functionality
  - Copy link (future)
  - Email report
...
- [ ] 4.2.1 - 4.2.3: Metadata input (3 tasks)
- [ ] 4.3.1 - 4.3.3: Info card display (3 tasks)
- [ ] 4.4.1 - 4.4.3: Export (3 tasks)
**Total: 13 tasks**
